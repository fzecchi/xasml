"""Plot the experimental Fe K-edge spectra of iron metal foil in this folder.
...
MEASUREMENTS = [
    ("M1  BMM, NSLS-II, RT", "NIST/Fe-K-IronFoil.xdi", {"mu_col": 3}, "#0072B2"),
    ("M2  APS 13-ID-E, RT", "XASLIB/Fe_Foil_rt_2016Foils_13IDE_01.xdi", {"ratio": (2, 1)}, "#D55E00"),
    ("M3  Joe Wong Standard, RT", "XASLIB/Fe_metal_rt_01.xdi", {"ratio": (1, 2)}, "#009E73"),
]

PRE_EDGE_DEFAULTS = {"pre1": -150, "pre2": -30, "norm1": 150, "norm2": 800, "nnorm": 2, "nvict": 2}


def normalized(path, ratio=None, mu_col=None):
