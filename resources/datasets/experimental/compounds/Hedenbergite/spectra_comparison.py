"""Plot the experimental Fe K-edge spectra of hedenbergite in this folder.
...
MEASUREMENTS = [
    ("M1  BMM, NSLS-II, RT", "NIST/Fe-Hedenbergite.xdi", {"mu_col": 3, "ref_cols": (5, 6)}, "#0072B2"),
    ("M2  BM02-FAME, ESRF, 293 K", "FAME/EXPERIMENT_DT_20170706_004-SPECTRUM_DT_20170706_004/XAS_trans_CaFeSi2O6/XAS_trans_CaFeSi2O6.data.txt", {"fame": True}, "#D55E00"),
]
...
def normalized(path, mu_col=None, ref_cols=None, fame=False):
