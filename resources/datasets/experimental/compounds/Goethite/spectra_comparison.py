"""Plot the unique experimental Fe K-edge spectra of goethite in this folder.
...
MEASUREMENTS = [
    (
        "M1  BMM, NSLS-II, RT",
        "NIST/Fe-Goethite.xdi",
        {"ratio": (4, 5), "ref_ratio": (5, 6)},
        "#0072B2",
    ),
    (
        "M2  IDEAS, CLS, RT",
        "XASDB/Goethite_idghzdol.dat",
        {"ratio": (1, 2), "ref_ratio": (2, 3)},
        "#E69F00",
    ),
    (
        "M3  BM08, ESRF, RT",
        "XASDB/Goethite_idsdehbq.dat",
        {"mu_column": 1, "drop_last": True},
        "#D55E00",
    ),
    (
        "M4  LISA, ESRF, RT",
        "XASDB/Goethite_id0t00uw.dat",
        {"mu_column": 1, "drop_last": True},
        "#CC79A7",
    ),
    (
        "M5  BM02-FAME, ESRF, RT",
        "FAME/EXPERIMENT_DT_20170706_005-SPECTRUM_DT_20170706_005/XAS_trans_FeOOH/XAS_trans_FeOOH.data.txt",
        {"fame": True},
        "#009E73",
    ),
]
...
def normalized(
    path, ratio=None, ref_ratio=None, mu_column=None, drop_last=False, fame=False
):
