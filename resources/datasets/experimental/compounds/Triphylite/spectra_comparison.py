"""Plot the experimental Fe K-edge spectrum of triphylite (LiFePO4) in this folder.
...
MEASUREMENTS = [
    ("M1  IDEAS, CLS, RT", "XASDB/Lithium Iron (II) Phosphate_id498e7h.dat", {"ratio": (1, 2), "ref_ratio": (2, 3)}, "#0072B2"),
]
