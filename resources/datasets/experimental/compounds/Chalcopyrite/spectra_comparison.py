"""Plot the experimental Fe K-edge spectra of chalcopyrite in this folder.
...
MEASUREMENTS = [
    ("M1  BM08-LISA, ESRF, 80 K", "LISA/CuFeS2_Fe_80K_111.xdi", {"mu_col": 1, "ref_col": 2}, "#0072B2"),
    ("M2  IDEAS, CLS, RT", "XASDB/Chalcopyrite_idx9912a.dat", {"ratio": (1, 2), "ref_ratio": (2, 3)}, "#D55E00"),
]

FE_K_EDGE = 7112.0
PRE_EDGE_DEFAULTS = {"pre1": -150, "pre2": -30, "norm1": 150, "norm2": 450, "nnorm": 2, "nvict": 2}


def normalized(path, ratio=None, ref_ratio=None, mu_col=None, ref_col=None):
