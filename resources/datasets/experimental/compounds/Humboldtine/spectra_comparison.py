"""Plot the experimental Fe K-edge spectra of humboldtine in this folder.
...
MEASUREMENTS = [
    ("M1  BMM, NSLS-II, RT", "NIST/Fe-Fe2Oxalate.xdi", {"mu_col": 3, "ref_cols": (5, 6)}, "#0072B2"),
    ("M2  IDEAS, CLS, RT", "XASDB/Iron (II) Oxalate_idng95ys.dat", {"ratio": (1, 2), "ref_ratio": (2, 3)}, "#D55E00"),
]

FE_K_EDGE = 7112.0
PRE_EDGE_DEFAULTS = {"pre1": -150, "pre2": -30, "norm1": 150, "norm2": 350, "nnorm": 2, "nvict": 2}


def normalized(path, mu_col=None, ref_cols=None, ratio=None, ref_ratio=None):
